...
public class StockService {
    ...
    public Flux<NewStock> streamStock() {
        System.setProperty("selenuim_config", "/home/novelistchan/Webflux/config.ini");
...
//        });
        ...
        OOSpider.create(Site.me().setSleepTime(1000)
                ...
                .setDownloader(new NewSeleniumDownloader("/home/novelistchan/Webflux/chromedriver")).thread(5).start();
